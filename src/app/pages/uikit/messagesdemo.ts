            ...
            <div class="md:w-1/2">
                <div class="card">
                    ...
                    <div class="flex mb-4 gap-1">
                        <input pInputText [(ngModel)]="username" placeholder="Username" aria-label="username"
                               class="ng-dirty ng-invalid"/>
                        <p-message severity="error" size="small" styleClass="h-full w-full ">Username is required
                        </p-message>
                    </div>
                    <div class="flex flex-wrap gap-1">
                        <input pInputText [(ngModel)]="email" placeholder="Email" aria-label="email"
                               class="ng-dirty ng-invalid"/>
