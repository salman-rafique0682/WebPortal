        ...
        <div class="grid grid-cols-12 gap-8">
            <div class="col-span-full lg:col-span-6">
                <div class="card">
                    ...
                    <p-fileupload name="demo1[]" (onUpload)="onUpload($event, 'advanced')" [multiple]="true"
            ...
            <div class="col-span-full lg:col-span-6">
                <div class="card">
                    ...
                    <div class="flex flex-col gap-6 items-center justify-center">
                        <p-fileupload #fu mode="basic" chooseLabel="Choose" chooseIcon="pi pi-upload" name="demo2[]"
                                      url="https://www.primefaces.org/cdn/api/upload.php" accept="image/*"
                                      maxFileSize="1000000" (onUpload)="onUpload($event, 'basic')"/>
