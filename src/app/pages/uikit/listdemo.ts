...
@Component({
    ...
    template: `
        <div class="flex flex-col space-y-4">
            <div class="card">
                <div class="font-semibold text-xl mb-6">DataView</div>
                                    ...
                                    <div
                                            ...
                                            <div class="bg-surface-100 p-1" style="border-radius: 30px">
                                                ...
                                                >
                                                    <span class="text-surface-900 font-medium text-sm"
                                                          style="line-height: 21px">{{ item.rating }}</span>
                                        ...
                                        <div class="flex flex-col md:items-end gap-8">
                                            ...
                                            <div class="flex flex-row-reverse md:flex-row gap-2">
                                                <p-button icon="pi pi-heart" styleClass="h-full"
                                    ...
                                    <div class="pt-12">
                                        <div class="flex flex-row justify-between items-start gap-2">
                                            ...
                                            <div class="bg-surface-100 p-1" style="border-radius: 30px">
                                                ...
                                                >
                                                    <span
                                                        class="text-surface-900 font-medium text-xs">{{ item.rating }}</span>
                                                    <i class="pi pi-star-fill text-yellow-500"></i>
                                                </div>
                                            </div>
                                        </div>
