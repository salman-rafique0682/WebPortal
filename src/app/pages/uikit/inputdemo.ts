        ...
        <p-fluid class="flex flex-col md:flex-row gap-8">
            <div class="md:w-1/2 space-y-4">
                <div class="card flex flex-col gap-4">
                    ...
                    <p-autocomplete [(ngModel)]="selectedAutoValue" [suggestions]="autoFilteredValue" optionLabel="name"
                                    placeholder="Search" (completeMethod)="filterCountry($event)"/>
            ...
            <div class="md:w-1/2 space-y-4">
                ...
                <div class="card flex flex-col gap-4">
                    ...
                    <p-multiselect [options]="multiselectCountries" [(ngModel)]="multiselectSelectedCountries"
                                   placeholder="Select Countries" optionLabel="name" display="chip" [filter]="true">
                        <ng-template #selecteditems let-countries>
                            @for (country of countries; track country.code) {
                                <div
                                    ...
                                    <span [class]="'mr-2 flag flag-' + country.code.toLowerCase()"
                    ...
                    <p-treeselect [(ngModel)]="selectedNode" [options]="treeSelectNodes"
