...
@Component({
    ...
    template: `
        <p-chart type="bar" [data]="chartData" [plugins]="plugins" [options]="chartOptions"
        ...
        return {
            ...
            scales: {
                x: {
                    ...
                    ticks: {
                        color: this.isDarkTheme() ? 'rgba(255, 255, 255, 0.40)' : surface400,
                        autoSkip: true,
                        maxRotation: 0,
                        source: 'data'
                    },
                ...
                y: {
                    ...
                    grid: {
                        display: true,
                        color: this.isDarkTheme() ? 'rgba(255, 255, 255, 0.08)' : surface200,
                        tickBorderDash: [2, 2]
                    },
                    border: {
                        dash: [8, 4],
