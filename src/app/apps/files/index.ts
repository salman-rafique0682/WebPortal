...
@Component({
    ...
    template: `
        <div class="grid grid-cols-12 gap-4">
            <div *ngFor="let metric of metrics" class="col-span-12 md:col-span-6 lg:col-span-3">
                <div class="card h-full">
                    <div class="flex items-center justify-between mb-4">
                        <span
                            class="text-surface-900 dark:text-surface-0 text-xl font-semibold">{{ metric.title }}</span>
                        <div>
                            <button pButton pRipple [icon]="metric.icon" text rounded size="small"
                    ...
                    <div>
                        ...
                        <div class="flex align-item-center justify-between">
                            <span
                                class="text-surface-900 dark:text-surface-0 mt-4 text-md font-medium">{{ metric.files }}</span>
                            <span
                                class="text-surface-900 dark:text-surface-0 mt-4 text-md font-medium">{{ metric.fileSize }}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-span-12 md:col-span-5 xl:col-span-3 space-y-4">
                <div class="card">
                    ...
                    <div class="flex flex-row justify-center" style="height: 200px">
                        <p-chart type="doughnut" [plugins]="chartPlugins" id="country-chart" [data]="fileChart"
                                 [options]="fileChartOptions" [style]="{ width: '200px' }"></p-chart>
                    </div>
            ...
            <div class="col-span-12 md:col-span-7 xl:col-span-9 space-y-4">
                <div class="card">
                        ...
                        <div *ngFor="let folder of folders" class="col-span-12 md:col-span-6 xl:col-span-4">
                            <div
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="text-surface-900 dark:text-surface-0 text-lg font-medium">{{ folder.name }}</span>
                                </div>
                                <span
                                    class="text-surface-600 dark:text-surface-200 text-lg font-semibold">{{ folder.size }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <ng-template pTemplate="header">
                            <tr>
                                <th pSortableColumn="name" style="min-width:12rem" class="white-space-nowrap">
                                    <span class="flex items-center gap-2">Name <p-sortIcon
                                        field="name"></p-sortIcon></span>
                                </th>
                                <th pSortableColumn="date" style="min-width:12rem" class="white-space-nowrap">
                                    <span class="flex items-center gap-2">Date <p-sortIcon
                                        field="date"></p-sortIcon></span>
                                </th>
                                <th pSortableColumn="fileSize" style="min-width:12rem" class="white-space-nowrap">
                                    <span class="flex items-center gap-2">File Size <p-sortIcon
                                        field="fileSize"></p-sortIcon></span>
                                </th>
                        ...
                        <ng-template pTemplate="body" let-file>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button pButton pRipple text rounded icon="pi pi-times" severity="danger"
                                            class="mr-2"></button>
