                ...
                <ng-template #content>
                    <div class="w-full py-4" style="cursor: copy"
                        ...
                        <div *ngIf="!uploadedFiles.length" class="h-full flex flex-col justify-center items-center">
                            ...
                            <span
                                class="font-bold text-surface-900 dark:text-surface-0 text-xl mb-4">Upload Files</span>
                        ...
                        <div class="w-full py-4" *ngIf="uploadedFiles.length" [style]="{ cursor: 'copy' }">
                            <div *ngFor="let file of uploadedFiles; let i = index" class="flex flex-wrap gap-8"
