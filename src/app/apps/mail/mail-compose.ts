    ...
    template: `
        <div
            ...
            <button pButton pRipple type="button" icon="pi pi-chevron-left"
                    ...
                    outlined severity="secondary" (click)="goBack()"></button>
        ...
        <div
            ...
            <div class="col-span-12">
                ...
                <p-iconfield style="height: 3.5rem" class="mt-4">
                    ...
                    <input id="to" type="text" pInputText [(ngModel)]="newMail.to"
                           class="!pl-16 text-surface-900 dark:text-surface-0 font-semibold" style="height: 3.5rem"
                           fluid/>
                </p-iconfield>
            </div>
            <div class="col-span-12">
                ...
                <p-iconfield style="height: 3.5rem" class="mt-4">
                    ...
                    <input id="subject" type="text" pInputText [(ngModel)]="newMail.title"
                           class="!pl-16 text-surface-900 dark:text-surface-0 font-semibold" fluid
                           style="height: 3.5rem"/>
                </p-iconfield>
            </div>
            <div class="col-span-12">
            ...
            <div class="col-span-12 flex gap-x-4 justify-end mt-16">
                <button pButton pRipple type="button" class="h-12 w-full sm:w-auto" icon="pi pi-send"
                        label="Send Message" (click)="sendMail()"></button>
            </div>
        </div>`
})
