        ...
        <div class="card">
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 lg:col-span-8">
                    <p-fileupload #uploader name="myfile[]" url="https://www.primefaces.org/cdn/api/upload.php"
                ...
                <div class="col-span-12 lg:col-span-4">
                    <div class="border border-surface-200 dark:border-surface-700 rounded mb-6">
                        ...
                        <div class="p-4">
                            <div class="bg-surface-100 dark:bg-surface-700 p-4 flex items-center rounded">
                                ...
                                <p-button type="button" icon="pi pi-fw pi-pencil" class="ml-auto" text
                                          rounded></p-button>
                            </div>
                        </div>
                        <div class="p-4">
                    ...
                    <p-fluid>
                        <div class="border border-surface-200 dark:border-surface-700 rounded mb-6">
                            <span
                                class="text-surface-900 dark:text-surface-0 font-bold block border-b border-surface-200 dark:border-surface-700 p-4">Meta</span>
                            <div class="p-4">
                                <div class="mb-6">
                                    <input pInputText type="text" placeholder="Title"/>
                                </div>
                    ...
                    <div class="flex justify-between gap-4">
                        <p-button class="flex-1" styleClass="w-full" severity="danger" outlined label="Discard"
                                  icon="pi pi-fw pi-trash"></p-button>
                        <p-button class="flex-1" styleClass="w-full" label="Publish"
                                  icon="pi pi-fw pi-check"></p-button>
                    </div>
                </div>
            </div>
        </div>
